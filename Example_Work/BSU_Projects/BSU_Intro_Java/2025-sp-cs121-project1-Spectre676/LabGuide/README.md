...
**Remember to commit your PLAN.md by the end of week 1**


## To Do
1. Create `MusicHero.java` in the `Project1` folder.
2. Execute the plan you created in PLAN.md
3. Be sure to review the requirements!
4. Remember to commit changes early and often as you work on the project!
